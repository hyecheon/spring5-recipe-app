package hclee.springframework.spring5recipeapp.bootstrap;

import hclee.springframework.spring5recipeapp.domain.*;
import hclee.springframework.spring5recipeapp.repository.CategoryRepository;
...
public class RecipeBootstrap implements ApplicationListener<ContextRefreshedEvent> {
    ...
    private List<Recipe> getRecipes() {
        ...
        guacRecipe.setDirections("1 Cut avocado, remove flesh: Cut the avocados in half. Remove seed. Score the inside of the avocado with a blunt knife and scoop out the flesh with a spoon" +
                ...
                "Chilling tomatoes hurts their flavor, so if you want to add chopped tomato to your guacamole, add it just before servings.\n" +
                "\n" +
                "\n" +
        ...
        tacosRecipe.setDirections("1 Prepare a gas or charcoal grill for medium-high, direct heat.\n" +
                ...
                "Wrap warmed tortillas in a tea towel to keep them warm until servings.\n" +
