...
import hclee.springframework.spring5recipeapp.commands.NotesCommand;
import hclee.springframework.spring5recipeapp.commands.RecipeCommand;
import hclee.springframework.spring5recipeapp.domain.Difficulty;
...
public class RecipeCommandToRecipeTest {
    ...
    public void testEmptyObject() throws Exception {
        final RecipeCommand source = new RecipeCommand();
        source.setNotes(new NotesCommand());
